...
**Enunciado.** En el triángulo $ABC$, sean $H$ el ortocentro y $M$ el pie de la mediatriz de $BC$. Demostrar que $B$, $H$, $M$, $C$ son concíclicos.

**Solución.** $\angle BHC = 180° - \angle BAC$ (propiedad del ortocentro: $\angle BHC + \angle BAC = 180°$). Y $\angle BMC = 2\angle BAC$ (ángulo central)... Este ejemplo requiere más setup. Veamos uno más limpio.
...
**Solución.** $\angle PAB = \angle PCD$ (ángulos inscritos sobre el arco $BD$, desde $A$ y $C$ respectivamente... hay que cuidar la orientación). Y $\angle APB = \angle CPD$ (ángulos opuestos en el vértice). Por AA: $\triangle PAB \sim \triangle PCD$. $\square$
